...
#define CONFIG_FB_ADDR				(0xC1E00000)//(0xD1000000)
...
#define CONFIG_BOOTARGS_TMK	"stm32_platform=stm-disco "\
				"mem=30M "\
				"console=tty0,115200 "\
				"console=ttyS0,115200 consoleblank=0 "\
        "root=/dev/mtdblock0 rdinit=/sbin/init "\
				"video=vfb:enable,fbmem:0xC1E00000,fbsize:0x100000"
        
#define CONFIG_BOOTARGS_EMCRAFT	"stm32_platform=stm-disco "\
				"mem=30M "\
				"console=tty0,115200 "\
				"console=ttyS0,115200 panic=10 "\
				"video=vfb:enable,fbmem:0xC1E00000,fbsize:0x100000"		
        
#define CONFIG_BOOTARGS CONFIG_BOOTARGS_EMCRAFT
