...
int QApplication::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: setStyleSheet((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 4: setAutoSipEnabled((*reinterpret_cast< const bool(*)>(_a[1]))); break;
        case 5: { bool _r = autoSipEnabled();
