...
static const char qt_meta_stringdata_QNetworkAccessManager[] = {
    "QNetworkAccessManager\0\0reply,authenticator\0"
...
int QNetworkAccessManager::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: authenticationRequired((*reinterpret_cast< QNetworkReply*(*)>(_a[1])),(*reinterpret_cast< QAuthenticator*(*)>(_a[2]))); break;
        case 1: finished((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        case 2: d_func()->_q_replyFinished(); break;
        case 3: d_func()->_q_replySslErrors((*reinterpret_cast< QList<QSslError>(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 4;
    }
